...
static func get_all_tracks() -> Array:
	return [_create_pionerskaya(), _create_fanera(), _create_fanera_sprint()]
...
static func _create_fanera_sprint() -> Resource:
	var script = load("res://race/race_tracks.gd")
	var track = script.new()
	track.track_name = "Фанера"
	track.track_id = "fanera_sprint"
	track.race_mode = "sprint"  # Sprint режим (без чекпоинтов)
	track.start_lat = 59.149827
	track.start_lon = 37.948859
	track.finish_lat = 59.141354
	track.finish_lon = 37.943516
	# Waypoints для предзагрузки чанков
	track.waypoints = [
		Vector2(59.149827, 37.948859),
		Vector2(59.147, 37.946),
		Vector2(59.144251, 37.944562),
		Vector2(59.144855, 37.938141),
		Vector2(59.141942, 37.937057),
		Vector2(59.141354, 37.943516)
	]
	# Те же route_points что и checkpoint версия для барьеров/миникарты
	track.route_points = [
		Vector2(59.149827, 37.948859),
		Vector2(59.149307, 37.948601),
		Vector2(59.148223, 37.947829),
